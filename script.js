    ...
    for (var i = 0; i < grid.length; i++) {
        ...
        for (var j = 0; j < grid[i].length; j++) {
            ...
            button.addEventListener('click', function() {
                ...
                clicks ++;
                document.getElementById('clicks').innerHTML = `Squares opened: ${clicks}`;
...
var newImg = function() {
    ...
    document.getElementById('clicks').innerHTML = `Squares opened: 0`;
...
var inputBoard = function() {
    ...
    var displayCorrectAnswer = document.createElement('h3');
    displayCorrectAnswer.setAttribute('id', 'correct-answer');
    answerBoard.appendChild(displayCorrectAnswer);
    ...
    var checkAnswer = function(userAnswer) {
        ...
        if (userAnswer === gameAnswer) {
            ...
            displayCorrectAnswer.innerText = `${gameAnswer} is the correct answer`;
            displayCorrectOrFalse.style.color = "#D8514E";
            console.log('in wronf func!')
            console.log("this is correct" + gameAnswer);
...
function scoreBoard() {
    ...
    //new clicks placeholder
    var clicksElement = document.createElement('h2');
    scoreAside.appendChild(clicksElement);

    clicksElement.innerHTML = `Squares opened: ${clicks}`;
    clicksElement.setAttribute('id', 'clicks');
